...
display(){
  if (this.capturado ==false) { // impide que el objeto capturado sea dibujado
     ...
     image(llaveImg,this.x,this.y,this.w,this.w)
  }
}
checkIfCapturado(){
...
function mousePressed() {
  ...
  //}
    if ((mouseX > 237 && mouseX < 403  && mouseY > 387 && mouseY < 412)){     
       buttons[0].reactionFunction();
    }
    if ((mouseX > 37 && mouseX < 203  && mouseY > 387 && mouseY < 412)){
