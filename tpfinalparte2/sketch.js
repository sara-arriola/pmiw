...
/*
class Pantallas {
  constructor(img1Path, img2Path, img3Path, img4Path) {
    this.img1 = loadImage(img1Path);
    this.img2 = loadImage(img2Path);
    this.img3 = loadImage(img3Path);
    this.img4 = loadImage(img4Path);
    this.currentImage = this.img1;     
  }
  
  mostrar(imagenSeleccionada) {
    switch (imagenSeleccionada) {
      ...
      case 1:
        ...
        break;
      case 2:
        this.currentImage = this.img3;
        break;
      case 3:
        this.currentImage = this.img4;
        break;  
    }
...
function preload(){
    ...
    //miPantalla = new Pantallas("Instrucciones.jpg", "Creditos.jpg","ganaste.jpg", "perdiste.jpg");     
...
function setup (){                     
          ...
          let buttons = [];
          let enemigos  = [];
          let coleccionDeLlavesdelJuego = [];
          miJuego = new Juego(configuracion,buttons,enemigos,coleccionDeLlavesdelJuego);
...
class Juego{
            constructor(config,buttons,enemigos,coleccionDeLlaves) {   
              ...
              this.buttons.push( new Button(320,450,166,28, 'rgb(0,255,0)','rgb(255,0,0)','JUGAR',jugarDenuevo));
              ...
              this.buttons.push(new Button(120,450,166,28,'rgb(0,255,0)','rgb(255,0,0)','CREDITOS',vercreditos));
          }              
