...
function mousePressed() {
  if ( (estado === 0 || estado === 1 || estado === 2 || estado === 3 || estado === 5 || estado === 7) && mouseX>= width - 60 && mouseX<=width && mouseY>=height / 2 -10 && mouseY<=height/2 + 10) {
    estado = (estado + 1);
  }
  //CREDITOS
  if (estado===0 && mouseX>=230 && mouseX<=410 && mouseY>=417 && mouseY<=447){
    estado=16;
  }
//VOLVER
if (estado===16 && mouseX>= width - 60 && mouseX<=width && mouseY>=height / 2 -10 && mouseY<=height/2 + 10){
 estado=0;
  audio.stop(); // Detiene el audio
}
   if (estado >= 1 && !audio.isPlaying()) {
        audio.play(); // Reproduce el audio
        audio.setLoop(true); // Hace que el audio se repita
        audio.setVolume(0.5); // Ajuste de volumen
    }
  //ESTADO 4
  else if (estado===4 && mouseX>=72.5 && mouseX<=202.5 && mouseY>=410 && mouseY<=430){
  estado = 5;
  }
  else if (estado===4 && mouseX>=275 && mouseX<=365 && mouseY>=410 && mouseY<=430){
estado=11;
  }
  else if (estado===4 && mouseX>=417.5 && mouseX<= 587.5 && mouseY>=410 && mouseY<= 430){
    estado=11;
  }
    //ESTADO 6
else if (estado===6 && mouseX>=143 && mouseX<=177 && mouseY>=409 && mouseY<=431){
  estado=7;
}
else if (estado===6 && mouseX>=463 && mouseX<=497 && mouseY>=409 && mouseY<=431){
  estado=12;
}
//ESTADO 8
else if (estado===8 && mouseX>=245 && mouseX<=395 && mouseY>=369 && mouseY<=399){
estado=9;
}
//ESTADO 9
else if(estado===9 && mouseX>=143 && mouseX<=177 && mouseY>=409 && mouseY<=431){
  estado=10;
}
else if(estado===9 && mouseX>=463 && mouseX<=497 && mouseY>=409 && mouseY<=431){
estado=13;
}
//ESTADO 11
    
else if(estado===11 && mouseX >= 72.5 && mouseX <= 202.5 && mouseY >= 410 && mouseY <= 4300 ||mouseX >= 275 && mouseX <= 365 && mouseY >= 410 && mouseY <= 430) {
    estado=12
  }
  else if (estado===11 && mouseX>=417.5 && mouseX<=587.5 && mouseY>=410 && mouseY<=430){
    estado=8;
  }
  //ESTADO 13
  else if (estado===13 && mouseX>=72.5 && mouseX<=202.5 && mouseY>=410 && mouseY<=430){
    estado=10;
  }
  else if (estado===13 && mouseX>=270 && mouseX<=370 && mouseY>=410 && mouseY<=430){
  estado=14;
}
else if (estado===13 && mouseX>=442.5 && mouseX<=562.5 && mouseY>=410 && mouseY<=430){
  estado=15;
}
//REINICIO
else if ((estado === 10 || estado === 12 || estado === 14 || estado === 15) && mouseX>=255 && mouseX<=385 && mouseY>=230 && mouseY<=250 && audio.isPlaying){
  estado=0;
  audio.stop(); // Detiene el audio
